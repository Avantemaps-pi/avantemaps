-- Fix security warning: Update existing function to have immutable search_path
CREATE OR REPLACE FUNCTION public.handle_subscription_after_payment(p_user_id uuid, p_username text, p_email text, p_subscription_tier text)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
