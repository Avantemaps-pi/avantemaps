          ...
          <div className="relative overflow-hidden">
            <div className="max-h-[450px] overflow-y-auto">
              <div className="space-y-3">
                <div className="grid grid-cols-[1fr_auto_1fr_1fr] gap-px sm:gap-1 mb-2 font-medium text-sm">
                ...
                {daysOfWeek.map((day) => (
                  <div key={day.name} className="grid grid-cols-[1fr_auto_1fr_1fr] gap-px sm:gap-1 items-center">
