          ...
          <div className="relative overflow-hidden">
            <div className="max-h-[450px] overflow-y-auto">
              <div className="space-y-3">
                <div className="grid grid-cols-[auto_auto_1fr_1fr] sm:grid-cols-[1fr_auto_1fr_1fr] gap-x-1.5 sm:gap-x-2 gap-y-0 mb-2 font-medium text-sm">
                ...
                {daysOfWeek.map((day) => (
                  <div key={day.name} className="grid grid-cols-[auto_auto_1fr_1fr] sm:grid-cols-[1fr_auto_1fr_1fr] gap-x-1.5 sm:gap-x-2 gap-y-0 items-center">
