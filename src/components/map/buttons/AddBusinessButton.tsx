...
const AddBusinessButton: React.FC<AddBusinessButtonProps> = ({ selectedPlace }) => {
  return (
    <div data-add-business-button className={`absolute bottom-20 sm:bottom-6 ${selectedPlace ? 'right-16 md:right-[calc(50%+200px)]' : 'right-6'} z-20 transition-all duration-300`}>
