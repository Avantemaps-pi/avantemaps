  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950 border border-blue-100 dark:border-blue-900 rounded-md w-full max-h-[600px] overflow-y-auto overflow-x-hidden">
          <div className="flex items-start text-left">
            ...
            <div className="w-full text-left">
              ...
              <ul className="mt-2 -ml-10 space-y-3 text-sm text-left">
