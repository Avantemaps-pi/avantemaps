          ...
          {[
            ...
            >
              <div className="flex items-center justify-between mb-4 px-4 md:px-[15px]">
                <h2 className="text-xl font-semibold flex items-center min-w-0 flex-1 mr-2">
                  <span className="bg-primary h-4 w-1 rounded-full mr-2 flex-shrink-0"></span>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center h-7 w-7 rounded-full text-primary hover:bg-primary/10 transition-colors flex-shrink-0"
                >
                  {isExpanded ? (
