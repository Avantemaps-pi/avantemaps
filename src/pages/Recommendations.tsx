...
const Recommendations = () => {
  ...
  return <AppLayout title="Recommendations" className="overflow-x-hidden">
      <div className="w-full mx-auto mt-4 pb-6 overflow-y-auto overflow-x-hidden px-0">
        <div className="space-y-6 pb-1 px-0 overflow-x-hidden">
          ...
          data,
          key
        }) => <section key={key} onMouseEnter={() => handleMouseEnter(key)} onMouseLeave={handleMouseLeave} onTouchStart={() => handleMouseEnter(key)} className="relative w-full overflow-x-hidden">
